...
const mainNavItems: NavItem[] = [
  ...
  { view: 'planillas', label: 'Control Stock', icon: <ClipboardCheckIcon />, roles: [Rol.ADMINISTRADOR] }, // Nuevo item
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, isSidebarOpen, currentUser, empresaSettings, appVersion }) => {
        ...
        <li key={item.view}>
          <a
            ...
            className={`flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
              currentView === item.view ? 'bg-gray-100 dark:bg-gray-700' : ''
            }`}
          >
